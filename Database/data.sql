...
(NULL, 'Pamela', 'Arizaga', 1, 'avatar1.png', NULL , NULL, 5, 5),
(NULL,  'Giovanni', 'Almazan', 1, 'avatar2.png', NULL , NULL, 5, 15),
(NULL, 'Rosa', 'Anaya', 0, 'avatar3.png', NULL , NULL, 5, 25),
(NULL, 'Ramses', 'Benavidez', 1, 'avatar4.png', NULL , NULL, 5, 35),
(NULL, 'Cassandra', 'Ceballos', 1, 'avatar5.png', NULL , NULL, 5, 45),
(NULL, 'Raul', 'Dominguez', 0, 'avatar6.png', NULL , NULL, 5, 55),
(NULL, 'Luis', 'Diaz', 0, 'avatar7.png', NULL , NULL, 5, 65),
(NULL, 'Vicente', 'Ruiz', 1, 'avatar8.png', NULL , NULL, 15, 75),
(NULL, 'Diego', 'Medina', 1, 'avatar9.png', NULL , NULL, 15, 85),
(NULL, 'Melissa', 'Puerto', 0, 'avatar10.png', NULL , NULL, 15, 95);
...
(NULL, 'Dejar en la entrada principal', 'ATENDIDO', 'EN PROCESO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 5),
(NULL,  'El domicilio esta a un costado de la capilla', 'ATENDIDO', 'EN PROCESO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 15),
(NULL, NULL, 'ENVIADO', 'PROCESANDO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 25),
(NULL, NULL, 'ENVIADO', 'PROCESANDO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 35),
(NULL, NULL, 'ENVIADO', 'PROCESANDO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 45),
(NULL, 'Dejar el paquete con el portero', 'ENTREGADO', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 55),
(NULL, NULL, 'ENTREGADO', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 65);
...
1, 'Paypal', 1500, 'producto1.png', 'Pamela Arizaga', 'ATENDIDO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 5),
(NULL,  'Royal Canin Alimento Húmedo para Perro Adulto Raza Yorkshire Terrier Receta Polloa', 
1, 'Tarjeta de Débito', 2000, 'producto2.png', 'Giovanni Almazan', 'ATENDIDO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 15),
(NULL, 'Royal Canin Kit Mix Feeding Weight Care Alimento Seco + Latas para Perro Adulto Raza Grande', 
1, 'Tarjeta de Crédito', 49.50, 'producto3.png', 'Rosa Anaya', 'ENVIADO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 25),
(NULL, 'Royal Canin Hydrolyzed Protein Premios para Perro', 
2, 'Paypal', 800, 'producto4.png', 'Ramses Benavidez', 'ENVIADO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 35),
(NULL, 'Kong Pelota de Goma Squeezz para Perro', 
5, 'Paypal', 63.90, 'producto5.png', 'Cassandra Ceballos', 'ENVIADO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 45),
(NULL, 'Kong Paquete con Tres Pelotas SqueakAir para Perro', 
1, 'Tarjeta de Débito', 120.0, 'producto6.png', 'Raul Dominguez', 'ENTREGADO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 55),
(NULL, 'Leaps & Bounds Pelota de Picos Colores Variados para Perro', 
3, 'Tarjeta de Débito', 150, 'producto7.png', 'Luis Diaz', 'ENTREGADO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 65);
...
(NULL, 'Alimento Seco', NULL, NULL, 5),
(NULL, 'Alimento Natural', NULL, NULL, 5),
(NULL, 'Alimento Húmedo', NULL, NULL, 5),
(NULL, 'Carnaza y Masticables', NULL, NULL, 15),
(NULL, 'Premios Suaves', NULL, NULL, 15),
(NULL, 'Galletas y Snacks', NULL, NULL, 15),
(NULL, 'Hogar', NULL, NULL, 25),
(NULL, 'Tazones y Alimentadores', NULL, NULL, 25),
(NULL, 'Entrenamiento', NULL, NULL, 25),
(NULL, 'Correas y Collares', NULL, NULL, 25),
(NULL, 'Antipulgas y garrapatas', NULL, NULL, 35),
(NULL, 'Limpieza y aseo', NULL, NULL, 35),
(NULL, 'Juguetes Masticable', NULL, NULL, 45);
...
(NULL, 'You & Me Comedero de Metal con Clip, Chico', 49.00, NULL, 'Apto para lavavajillas y resistente a los rasguños. Para las aves y otros animales pequeños. Abrazadera de soporte se adapta fácilmente a cualquier estilo jaula.', NULL,'producto19.jpg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 75, 175, 25),
